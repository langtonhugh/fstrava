...
This is just a code chunk and `leafet` map for a demo. It will work to expand the existing script on [fstrava](https://github.com/langtonhugh/fstrava/blob/main/scripts/activities_explore.R).


```{r leafletmap, out.width="900px"}
# Load libraries.
library(pbapply)
library(XML)
library(dplyr)
